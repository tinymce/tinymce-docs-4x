...
This plugin adds a toolbar button that allows a user to edit the HTML code using a more advanced link:{baseurl}/enterprise/advcode.html[code editor] than the default textarea.
