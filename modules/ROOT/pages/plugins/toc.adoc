...
Internally plugin doesn't apply any inline styles. Basic formatting can be added via link:{baseurl}/advanced/boilerplate-content-css.html[Boilerplate Content CSS], that can be customised to your needs.
...
With `toc_class` you can change the class name that gets assigned to the wrapper `div`. Please note that you will have to alter link:{baseurl}/advanced/boilerplate-content-css.html[Boilerplate Content CSS]) accordingly.
