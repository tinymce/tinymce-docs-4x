...
| <<pastepreprocess,PastePreProcess>> | link:{baseurl}/plugins/paste.html[paste] | Fires when contents are pasted into the editor. |
| <<pastepostprocess,PastePostProcess>> | link:{baseurl}/plugins/paste.html[paste] | Fires when contents are pasted into the editor. |
