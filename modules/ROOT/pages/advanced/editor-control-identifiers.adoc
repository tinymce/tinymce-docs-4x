...
| hr
| link:{baseurl}/plugins/hr.html[hr]
...
| help
| link:{baseurl}/plugins/help.html[help]
...
| emoticons
| link:{baseurl}/plugins/emoticons.html[emoticons]
...
| restoredraft
| link:{baseurl}/plugins/autosave.html[restoredraft]
| Restores to the latest auto saved draft.

| insertfile
| link:{baseurl}/plugins/moxiemanager.html[moxiemanager]
| Opens the MoxieManager dialog.

| a11ycheck
| link:{baseurl}/plugins/a11ychecker.html[a11ychecker]
...
| quickimage
| link:{baseurl}/themes/inlite.html[inlite]
...
| restoredraft
| link:{baseurl}/plugins/autosave.html[autosave]
| Restores to the latest auto saved draft.
