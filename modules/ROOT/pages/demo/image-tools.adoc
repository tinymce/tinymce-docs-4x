...
This example contains the plugins needed for the most common use cases as well as the link:{baseurl}/plugins/imagetools.html[Image Tools] Plugin. Click on the image to make the inline toolbar for image editing appear.
