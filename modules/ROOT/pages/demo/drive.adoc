...
This example shows you how to use Tiny Drive for your file and image management. For more information on the Tiny Drive plugin, see the link:{baseurl}/plugins/drive.html[docs].
