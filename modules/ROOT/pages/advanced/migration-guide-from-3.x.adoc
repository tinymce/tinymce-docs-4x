...
These are the new plugins in 4.0: link:{baseurl}/plugins/anchor.html[anchor], link:{baseurl}/plugins/charmap.html[charmap], link:{baseurl}/plugins/compat3x.html[compat3x], link:{baseurl}/plugins/hr.html[hr], link:{baseurl}/plugins/image.html[image], link:{baseurl}/plugins/link.html[link], link:{baseurl}/plugins/emoticons.html[emoticons], link:{baseurl}/plugins/code.html[code] and link:{baseurl}/plugins/textcolor.html[textcolor].
