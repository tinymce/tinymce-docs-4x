...
A [TinyMCE Enterprise]({{site.pricingpage}}) subscription includes the ability to download and install the accessibility checker feature for the editor.

Accessibility checker is part of the demo [on the main page of TinyMCE site]({{site.homepage}}). For more information about the accessibility checker [see this blog post]({{site.blog}}tinymce-enterprise-update-benefits-accessibility-users-brings-atmentions/).
